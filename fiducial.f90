...
Real*8,parameter :: Omega_L0 = 0.718d0    ! 1 - Omega_m0 : Dark energy parameter density (LCDM model) at present time in a flat universe
...
Real*8,parameter :: kmax = 1.d3    ! #*H_0*1.e-2 # maximum wavenumber to compute angular power spectrum of lensing potential 
...
Integer*4,parameter :: number_of_M = 1d5    ! size of virial mass array
