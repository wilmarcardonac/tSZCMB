Module fiducial
    ...
    Integer*4,parameter :: number_of_M = 100 !number_of_M_log + number_of_M_linear
    Integer*4,parameter :: number_of_l = 50  ! SIZE OF MULTIPOLE ARRAY 
    ...
    Real*8,parameter :: zminlimber = 1.d-5         ! LOWER RED-SHIFT FOR LIMBER APPROXIMATION
