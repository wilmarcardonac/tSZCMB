...
Integer*4,parameter :: number_of_M = 1d2    ! size of virial mass array
Integer*4,parameter :: number_of_l = 11    ! size of l array
Integer*4,parameter :: lmax = 1d3    ! highest multipole
Integer*4,parameter :: lmin = 2d0    ! lowest multipole 
